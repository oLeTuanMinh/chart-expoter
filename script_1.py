# Tạo code example cho việc sử dụng AWS GetMetricWidgetImage API
example_code = '''// AWS CloudWatch GetMetricWidgetImage API Example
...
# Lưu code example thành file
with open('cloudwatch-api-example.js', 'w', encoding='utf-8') as f:
    f.write(example_code)

print("✅ Đã tạo file cloudwatch-api-example.js với các ví dụ sử dụng API")
print("\n📋 File bao gồm:")
print("- Class CloudWatchChartExporter hoàn chỉnh") 
print("- Methods để tạo widget config, export chart, download PNG")
print("- Các ví dụ sử dụng cho EC2, RDS, Lambda")
